...
pub fn stories() -> Vec<Story> {
    vec![
        Story::new(
            "Views",
            "CollisionsPage / Positions (empty)",
            collisions_page_positions,
        ),
        Story::new(
            "Views",
            "CollisionsPage / Hotkeys (empty)",
            collisions_page_hotkeys,
        ),
        Story::new(
            "Views",
            "CollisionsPage / Unit positions (empty)",
            collisions_page_unit_positions,
        ),
        Story::new("Views", "ResolvePage (empty)", resolve_page_story),
        Story::new(
            "Views",
            "IslandMiniGrid / top-left",
            island_mini_grid_top_left,
        ),
        Story::new("Views", "IslandMiniGrid / center", island_mini_grid_center),
        Story::new(
            "Views",
            "IslandMiniGrid / bottom-right",
            island_mini_grid_bottom_right,
        ),
        Story::new("Views", "IslandSidebar / empty", island_sidebar_empty),
        Story::new("Views", "IslandDetail / empty", island_detail_empty),
        Story::new(
            "Views",
            "HotkeyUnitSidebar / empty",
            hotkey_unit_sidebar_empty,
        ),
        Story::new(
            "Views",
            "HotkeyUnitDetail / empty",
            hotkey_unit_detail_empty,
        ),
        Story::new(
            "Views",
            "UnitPositionSidebar / empty",
            unit_position_sidebar_empty,
        ),
        Story::new(
            "Views",
            "UnitPositionDetail / empty",
            unit_position_detail_empty,
        ),
    ]
}
