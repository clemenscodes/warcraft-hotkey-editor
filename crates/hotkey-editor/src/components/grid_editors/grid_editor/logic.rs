...
use crate::components::grid_editors::grid_editor::components::{
    GridHeadingProps, GridProps, GridTileFlags, GridTileView,
};
...
use super::props::GridEditorProps;
...
/// Resolves the editor into the generic grid engine's props: the views the domain
...
impl<B: GridBehavior> From<&GridEditorProps<B>> for GridProps {
    fn from(props: &GridEditorProps<B>) -> Self {
