...
use crate::components::grid_editors::grid_editor::GridTileProps;
use crate::components::grid_editors::grid_editor::GridTileState;
use crate::model::grid::DragFollowerVisual;

use super::super::props::GridProps;
use super::mechanics;
...
impl From<&GridProps> for GridRender {
