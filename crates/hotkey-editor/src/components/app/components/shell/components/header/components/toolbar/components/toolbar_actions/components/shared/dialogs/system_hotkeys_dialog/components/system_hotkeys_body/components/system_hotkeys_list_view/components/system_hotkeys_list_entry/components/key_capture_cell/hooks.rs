...
/// pick / close handlers.
pub(super) struct KeyCaptureCellModel {
    pub(super) state: KeyCaptureCellState,
...
/// Resolves the chip's effective binding, detects conflicts, and wires the edit /
/// pick / close handlers.
pub(super) fn use_key_capture_cell(props: &KeyCaptureCellProps) -> KeyCaptureCellModel {
