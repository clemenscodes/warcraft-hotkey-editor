...
/// The published `View` contract mirroring [`HotkeyAltPositionPickerPanelModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct HotkeyAltPositionPickerPanelView {
    pub title: String,
...
impl ddd::View for HotkeyAltPositionPickerPanelView {}
