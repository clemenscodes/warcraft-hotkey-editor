...
pub struct SelectedCollisionCardSurfaceModel {
    pub onclick: EventHandler<MouseEvent>,
    pub count: usize,
    pub content: CollisionCardContent,
}

impl From<&SelectedCollisionCardSurfaceView> for SelectedCollisionCardSurfaceModel {
...
impl ddd::Model for SelectedCollisionCardSurfaceModel {
