use super::view::HotkeyUpgradePositionPickerPanelView;
...
pub struct HotkeyUpgradePositionPickerPanelModel {
    pub title: String,
...
impl From<&HotkeyUpgradePositionPickerPanelView> for HotkeyUpgradePositionPickerPanelModel {
    fn from(view: &HotkeyUpgradePositionPickerPanelView) -> Self {
        let HotkeyUpgradePositionPickerPanelView {
            title,
            on_close,
            explainer_text,
            grid_config,
...
impl ddd::Model for HotkeyUpgradePositionPickerPanelModel {
    type View = HotkeyUpgradePositionPickerPanelView;
}
