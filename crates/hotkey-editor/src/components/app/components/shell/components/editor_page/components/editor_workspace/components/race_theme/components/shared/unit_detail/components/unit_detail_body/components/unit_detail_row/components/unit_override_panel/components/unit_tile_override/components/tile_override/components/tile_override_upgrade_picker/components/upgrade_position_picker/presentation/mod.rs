use super::model::UpgradePositionPickerModel;
...
impl From<&UpgradePositionPickerPresentation> for UpgradePositionPickerShell {
    fn from(model: &UpgradePositionPickerPresentation) -> Self {
...
pub(super) struct UpgradePositionPickerPresentation {
...
pub(super) fn use_upgrade_position_picker(
    props: &UpgradePositionPickerModel,
) -> UpgradePositionPickerPresentation {
