...
pub use view::HotkeyUpgradePositionPickerPanelView;
mod style;
...
use model::HotkeyUpgradePositionPickerPanelModel;
use style::CLASS;
...
/// scrolling grid body.
#[component]
pub fn HotkeyUpgradePositionPickerPanel(props: HotkeyUpgradePositionPickerPanelModel) -> Element {
    let HotkeyUpgradePositionPickerPanelModel {
        title,
        on_close,
        explainer_text,
        grid_config,
...
assert_component!(HotkeyUpgradePositionPickerPanel);
