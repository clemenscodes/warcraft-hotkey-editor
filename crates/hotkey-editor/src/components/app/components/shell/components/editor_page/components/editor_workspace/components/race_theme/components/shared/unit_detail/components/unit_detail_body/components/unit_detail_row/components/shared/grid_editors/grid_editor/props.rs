...
/// The `GridEditor` component's internal model (a `ddd::Props`): a [`GridEditorView`]
...
impl<B: GridBehavior> From<&GridEditorView> for GridEditorProps<B> {
...
impl<B: GridBehavior> ddd::Props for GridEditorProps<B> {
