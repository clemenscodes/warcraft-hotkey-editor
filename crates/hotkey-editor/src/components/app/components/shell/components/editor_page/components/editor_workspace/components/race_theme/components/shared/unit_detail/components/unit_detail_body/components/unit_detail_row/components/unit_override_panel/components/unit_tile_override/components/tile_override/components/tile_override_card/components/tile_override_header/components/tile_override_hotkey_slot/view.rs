...
/// The published `View` contract mirroring [`TileOverrideHotkeySlotProps`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct TileOverrideHotkeySlotView {
...
impl ddd::View for TileOverrideHotkeySlotView {}
