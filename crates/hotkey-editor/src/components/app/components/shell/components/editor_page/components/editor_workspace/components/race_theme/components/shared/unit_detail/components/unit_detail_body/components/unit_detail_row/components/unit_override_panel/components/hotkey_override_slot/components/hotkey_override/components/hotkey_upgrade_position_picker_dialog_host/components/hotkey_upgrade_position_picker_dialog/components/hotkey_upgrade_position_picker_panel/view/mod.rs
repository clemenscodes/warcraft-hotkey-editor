...
/// The published `View` contract mirroring [`HotkeyUpgradePositionPickerPanelModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct HotkeyUpgradePositionPickerPanelView {
    pub title: String,
...
impl ddd::View for HotkeyUpgradePositionPickerPanelView {}
