...
pub struct SystemHotkeysDialogPanelModel {
    #[props(into)]
    pub title: String,
    pub on_close: EventHandler<()>,
}

impl From<&SystemHotkeysDialogPanelView> for SystemHotkeysDialogPanelModel {
...
impl ddd::Model for SystemHotkeysDialogPanelModel {
