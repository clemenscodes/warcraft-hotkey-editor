...
/// The published `View` contract mirroring [`UpgradePositionPickerPanelProps`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct UpgradePositionPickerPanelView {
    pub title: String,
...
impl ddd::View for UpgradePositionPickerPanelView {}
