...
/// label, `data-label` selector hook, disabled flag, click handler, conflict tooltip),
/// all passed straight through to the color leaf this slot sizes. Oversized caps
