...
use crate::components::app::components::shell::components::editor_page::components::editor_workspace::components::race_theme::components::unit_detail::components::unit_stats_panel::components::attributes_column::components::attribute_rows::components::shared::primary_attribute_label::PrimaryAttributeLabel;
...
use dioxus::prelude::*;
pub use props::RegularStrengthRowProps;
use style::CLASS;
...
#[component]
pub fn RegularStrengthRow(props: RegularStrengthRowProps) -> Element {
