use super::components::layout_editor_panel::components::layout_editor_body::components::layout_editor_content::components::layout_grid::components::layout_tile::LayoutTileState;
...
use super::model::LayoutEditorModel;
...
/// happens here.
pub(super) struct LayoutEditorPresentation {
...
fn use_layout_actions(props: &LayoutEditorModel) -> LayoutActions {
...
pub(super) fn use_layout_editor(props: &LayoutEditorModel) -> LayoutEditorPresentation {
    let open = props.open;
    let grid_layout = props.grid_layout;
...
impl ddd::Presentation for LayoutActions {
    type Model = LayoutEditorModel;
}
