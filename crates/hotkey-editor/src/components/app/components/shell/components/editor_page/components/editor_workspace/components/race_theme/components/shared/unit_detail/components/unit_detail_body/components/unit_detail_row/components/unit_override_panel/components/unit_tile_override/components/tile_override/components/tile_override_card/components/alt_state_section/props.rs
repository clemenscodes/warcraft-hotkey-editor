...
use super::components::alt_state_header::AltStateHeaderProps;
use super::components::alt_state_header::components::alt_state_controls::AltStateControlsProps;
...
impl From<&AltStateSectionProps> for AltStateHeaderProps {
    fn from(props: &AltStateSectionProps) -> Self {
