...
/// The published `View` contract mirroring [`CollisionCardSurfaceModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct CollisionCardSurfaceView {
...
impl ddd::View for CollisionCardSurfaceView {}
