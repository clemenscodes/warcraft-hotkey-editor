...
use presentation::{HotkeySlotKeyCell, TileOverrideHotkeySlotDispatch};
use tw_macro::assert_component;

use model::TileOverrideHotkeySlotModel;

/// The hotkey / research-hotkey / passive-note slot in the override header. Renders
/// exactly the one that applies, or nothing.
#[component]
pub fn TileOverrideHotkeySlot(props: TileOverrideHotkeySlotModel) -> Element {
