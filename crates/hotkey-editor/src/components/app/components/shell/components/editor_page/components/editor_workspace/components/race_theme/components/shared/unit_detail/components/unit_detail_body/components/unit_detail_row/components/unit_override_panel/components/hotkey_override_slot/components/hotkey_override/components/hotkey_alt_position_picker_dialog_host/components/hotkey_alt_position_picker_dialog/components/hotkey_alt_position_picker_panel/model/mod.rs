use super::view::HotkeyAltPositionPickerPanelView;
...
pub struct HotkeyAltPositionPickerPanelModel {
    pub title: String,
...
impl From<&HotkeyAltPositionPickerPanelView> for HotkeyAltPositionPickerPanelModel {
    fn from(view: &HotkeyAltPositionPickerPanelView) -> Self {
        let HotkeyAltPositionPickerPanelView {
            title,
            on_close,
            explainer_text,
            grid_config,
...
impl ddd::Model for HotkeyAltPositionPickerPanelModel {
    type View = HotkeyAltPositionPickerPanelView;
}
