...
use super::model::TileOverrideHotkeySlotModel;
...
impl From<&TileOverrideHotkeySlotModel> for TileOverrideHotkeySlotDispatch {
    fn from(props: &TileOverrideHotkeySlotModel) -> Self {
...
impl ddd::Presentation for TileOverrideHotkeySlotDispatch {
    type Model = TileOverrideHotkeySlotModel;
}
