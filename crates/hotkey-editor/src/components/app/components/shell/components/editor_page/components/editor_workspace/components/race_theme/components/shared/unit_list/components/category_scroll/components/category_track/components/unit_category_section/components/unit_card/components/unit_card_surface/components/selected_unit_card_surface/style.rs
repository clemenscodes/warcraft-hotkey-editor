...
classes! {
    base: tw![
        ...
        "text-[color:var(--race-color)]",
        "[--glow-color:var(--race-color)]",
        "shadow-glow-soft",
    ],
    mobile: tw!["mobile:h-full","mobile:py-2","mobile:px-2.5","mobile:gap-2.5","mobile:box-border","mobile:overflow-hidden","mobile:bg-panel-dark","mobile:border-warcraft-blue/60", "mobile:[--name-color:var(--color-white)]"],
    tablet: tw!["tablet:h-full","tablet:py-2","tablet:px-2.5","tablet:gap-2.5","tablet:box-border","tablet:overflow-hidden","tablet:bg-panel-dark","tablet:border-warcraft-blue/60", "tablet:[--name-color:var(--color-white)]"],
}
