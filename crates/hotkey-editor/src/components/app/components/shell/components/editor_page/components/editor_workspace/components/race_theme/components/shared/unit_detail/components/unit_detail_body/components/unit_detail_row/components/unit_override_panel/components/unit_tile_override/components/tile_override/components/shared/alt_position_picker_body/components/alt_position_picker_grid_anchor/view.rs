...
/// The published `View` contract mirroring [`AltPositionPickerGridAnchorProps`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct AltPositionPickerGridAnchorView {
    pub grid_config: GridEditorView,
}

impl ddd::View for AltPositionPickerGridAnchorView {}
