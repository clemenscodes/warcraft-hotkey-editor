use super::view::HotkeyPickerDialogHostDialogView;
use dioxus::prelude::*;
...
pub struct HotkeyPickerDialogHostDialogModel {
    pub visible: bool,
    pub title: String,
...
impl From<&HotkeyPickerDialogHostDialogView> for HotkeyPickerDialogHostDialogModel {
    fn from(view: &HotkeyPickerDialogHostDialogView) -> Self {
        let HotkeyPickerDialogHostDialogView {
            visible,
            title,
            rows,
            on_pick,
...
impl ddd::Model for HotkeyPickerDialogHostDialogModel {
    type View = HotkeyPickerDialogHostDialogView;
}
