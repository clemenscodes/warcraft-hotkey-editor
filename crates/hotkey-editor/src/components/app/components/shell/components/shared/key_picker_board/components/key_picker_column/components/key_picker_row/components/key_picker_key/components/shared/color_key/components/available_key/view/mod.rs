...
/// The published `View` contract mirroring [`AvailableKeyModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct AvailableKeyView {
    pub label: String,
    pub disabled: bool,
...
impl ddd::View for AvailableKeyView {}
