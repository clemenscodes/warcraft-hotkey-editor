...
pub fn TileOverrideCard(props: TileOverrideCardProps) -> Element {
    let TileOverrideCardProps {
        ...
        description_lines, alt_name_text, alt_description_lines, show_alt_controls,
        alt_hotkey_label, alt_hotkey_is_editing, alt_hotkey_is_special_token,
        on_alt_position_click, on_alt_hotkey_activate, upgrade_show, upgrade_hotkey_label,
        upgrade_is_editing, upgrade_hotkey_is_special, on_upgrade_position_click,
        on_upgrade_hotkey_activate, active_tier_index, total_tier_count, tier_label_text,
    } = props;
    rsx! {
        div { class: CLASS,
            TileOverrideHeader {
