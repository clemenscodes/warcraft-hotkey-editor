use super::model::AttackMatchupModel;
...
pub(super) struct AttackMatchupPresentation {
...
pub(super) fn use_attack_matchup(props: &AttackMatchupModel) -> AttackMatchupPresentation {
...
impl ddd::Presentation for AttackMatchupPresentation {
    type Model = AttackMatchupModel;
}
