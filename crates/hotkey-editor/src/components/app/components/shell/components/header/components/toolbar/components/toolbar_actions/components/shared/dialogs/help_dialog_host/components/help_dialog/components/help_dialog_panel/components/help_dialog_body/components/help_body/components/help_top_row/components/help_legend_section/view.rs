...
/// The published `View` contract mirroring [`HelpLegendSectionProps`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct HelpLegendSectionView {
    pub rows: &'static [HelpLegendEntry],
}

impl ddd::View for HelpLegendSectionView {}
