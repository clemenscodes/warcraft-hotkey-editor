...
// (caption/key/tooltip) of a slot being dragged while keeping its frame. The
// highlighted look adds a gold glow overlay (its picker is open, or it is the current
// drop target).
classes! {
    base: tw![
        "size-full",
