...
pub use view::PrimaryStrengthRowView;
mod style;

use crate::components::app::components::shell::components::editor_page::components::editor_workspace::components::race_theme::components::shared::unit_detail::components::unit_stats_panel::components::attributes_stats_host::components::attributes_stats::components::attribute_rows::components::shared::primary_attribute_label::PrimaryAttributeLabel;
...
use dioxus::prelude::*;
use model::PrimaryStrengthRowModel;
use style::CLASS;
