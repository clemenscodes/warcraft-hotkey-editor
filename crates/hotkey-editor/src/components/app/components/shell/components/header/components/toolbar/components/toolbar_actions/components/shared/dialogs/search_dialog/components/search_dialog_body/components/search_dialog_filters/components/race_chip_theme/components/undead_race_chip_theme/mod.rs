...
pub use view::UndeadRaceChipThemeView;
...
use dioxus::prelude::*;
use model::UndeadRaceChipThemeModel;
use style::CLASS;
use tw_macro::assert_component;

#[component]
pub fn UndeadRaceChipTheme(props: UndeadRaceChipThemeModel) -> Element {
...
assert_component!(UndeadRaceChipTheme);
