...
use crate::components::app::components::shell::components::resolve_page::components::plan_body::components::move_list::components::move_row::components::move_panel::MovePanelProps;
use dioxus::prelude::*;
