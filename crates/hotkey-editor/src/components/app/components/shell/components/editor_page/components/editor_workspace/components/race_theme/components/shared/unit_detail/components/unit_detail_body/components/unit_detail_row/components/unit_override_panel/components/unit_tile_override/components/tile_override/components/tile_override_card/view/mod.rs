...
/// The published `View` contract mirroring [`TileOverrideCardModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct TileOverrideCardView {
...
impl ddd::View for TileOverrideCardView {}
