use super::components::success_toast_content::SuccessToastContentProps;
...
impl From<&SuccessToastCardProps> for SuccessToastContentProps {
    fn from(props: &SuccessToastCardProps) -> Self {
