...
pub use view::OrcRaceChipThemeView;
...
use dioxus::prelude::*;
use model::OrcRaceChipThemeModel;
use style::CLASS;
use tw_macro::assert_component;

#[component]
pub fn OrcRaceChipTheme(props: OrcRaceChipThemeModel) -> Element {
...
assert_component!(OrcRaceChipTheme);
