...
// (caption/key/tooltip) of a slot being dragged while keeping its frame.
classes! {
    base: tw![
        "size-full",
        "flex",
...
states! {
    SystemSlotState,
    Idle => tw![],
    Highlighted => tw!["filter-[brightness(1.32)_drop-shadow(0_0_14px_color-mix(in_oklab,var(--color-warcraft-gold)_75%,transparent))]"],
