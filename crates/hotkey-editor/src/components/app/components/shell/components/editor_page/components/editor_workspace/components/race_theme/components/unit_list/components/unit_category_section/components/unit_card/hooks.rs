...
/// The card's shaped view: the kind data attribute the wrapper's carousel filter
/// reads, and the select handlers.
...
pub(super) fn use_unit_card(props: &UnitCardProps) -> UnitCardModel {
    ...
    let kind_attr = crate::components::app::components::shell::components::editor_page::components::editor_workspace::components::race_theme::components::unit_list::unit_kind_data_attr(unit_kind);
