...
/// The published `View` contract mirroring [`HelpDialogBodyProps`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct HelpDialogBodyView {
    pub content: HelpContent,
    pub on_dismiss: EventHandler<MouseEvent>,
}

impl ddd::View for HelpDialogBodyView {}
