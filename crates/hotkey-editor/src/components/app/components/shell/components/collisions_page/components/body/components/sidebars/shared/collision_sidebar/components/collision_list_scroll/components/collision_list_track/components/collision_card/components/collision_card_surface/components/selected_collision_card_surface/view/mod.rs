...
/// The published `View` contract mirroring [`SelectedCollisionCardSurfaceModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct SelectedCollisionCardSurfaceView {
    pub onclick: EventHandler<MouseEvent>,
    pub count: usize,
    pub content: CollisionCardContent,
}

impl ddd::View for SelectedCollisionCardSurfaceView {}
