...
pub struct UpgradePositionPickerPanelModel {
    pub title: String,
...
impl From<&UpgradePositionPickerPanelView> for UpgradePositionPickerPanelModel {
...
impl ddd::Model for UpgradePositionPickerPanelModel {
