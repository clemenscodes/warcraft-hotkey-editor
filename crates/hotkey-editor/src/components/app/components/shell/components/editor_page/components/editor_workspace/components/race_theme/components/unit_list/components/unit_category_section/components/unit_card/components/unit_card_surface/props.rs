...
/// out, the selected flag the dispatcher reads to pick the look, the card's race (which
/// tints the accent), and the click/keydown/mount handlers the card wires onto its
/// button.
