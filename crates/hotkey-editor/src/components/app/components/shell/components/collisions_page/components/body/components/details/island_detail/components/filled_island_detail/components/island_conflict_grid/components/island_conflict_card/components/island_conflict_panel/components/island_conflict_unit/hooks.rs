use super::components::conflict_unit_icon::ConflictUnitIconProps;
use super::props::IslandConflictUnitProps;
use crate::services::navigation::context::use_view_navigation;
use dioxus::prelude::*;
use warcraft_api::WarcraftObjectId;

/// The shaped affected-unit heading: its icon, name, and id, plus the open-unit handler
/// wired from the navigation read from context.
pub(super) struct IslandConflictUnitModel {
    pub(super) icon: ConflictUnitIconProps,
