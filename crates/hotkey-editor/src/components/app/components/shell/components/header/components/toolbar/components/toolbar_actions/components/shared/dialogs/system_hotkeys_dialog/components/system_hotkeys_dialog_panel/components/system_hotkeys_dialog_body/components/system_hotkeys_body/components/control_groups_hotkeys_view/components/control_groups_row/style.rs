...
classes! {
    base: tw![
        ...
        "[--slot-frame-slice:12]",
        "[--slot-frame-pad-x:calc(var(--spacing)*1.5)]",
        "[--slot-frame-pad-y:calc(var(--spacing)*3)]",
        "[--slot-frame-gap:calc(var(--spacing)*1.5)]",
        "[--slot-key-size:var(--text-3xl)]",
        "[--slot-host-min-h:calc(var(--spacing)*44)]",
        "[--slot-host-aspect:1]",
    ],
    mobile: tw![
        "mobile:grid-cols-5",
        ...
        "mobile:[--slot-frame-pad-y:calc(var(--spacing)*1.5)]",
    ...
    tablet: tw![
        ...
        "tablet:[--slot-frame-pad-y:calc(var(--spacing)*1.5)]",
