...
/// The published `View` contract mirroring [`CollisionCardVisualProps`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct CollisionCardVisualView {
    pub content: CollisionCardContent,
}

impl ddd::View for CollisionCardVisualView {}
