...
pub use view::NeutralRaceChipThemeView;
...
use dioxus::prelude::*;
use model::NeutralRaceChipThemeModel;
use style::CLASS;
use tw_macro::assert_component;

#[component]
pub fn NeutralRaceChipTheme(props: NeutralRaceChipThemeModel) -> Element {
...
assert_component!(NeutralRaceChipTheme);
