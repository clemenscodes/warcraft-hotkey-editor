...
pub use view::HumanRaceChipThemeView;
...
use dioxus::prelude::*;
use model::HumanRaceChipThemeModel;
use style::CLASS;
use tw_macro::assert_component;

#[component]
pub fn HumanRaceChipTheme(props: HumanRaceChipThemeModel) -> Element {
...
assert_component!(HumanRaceChipTheme);
