...
pub use view::NightelfPagerCardThemeView;
...
use dioxus::prelude::*;
use model::NightelfPagerCardThemeModel;
use style::CLASS;
use tw_macro::assert_component;

#[component]
pub fn NightelfPagerCardTheme(props: NightelfPagerCardThemeModel) -> Element {
...
assert_component!(NightelfPagerCardTheme);
