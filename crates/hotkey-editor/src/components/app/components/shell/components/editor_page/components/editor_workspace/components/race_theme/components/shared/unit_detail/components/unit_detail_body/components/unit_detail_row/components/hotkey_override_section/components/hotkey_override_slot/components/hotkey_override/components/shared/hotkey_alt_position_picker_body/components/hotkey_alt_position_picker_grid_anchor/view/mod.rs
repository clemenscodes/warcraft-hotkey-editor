...
/// The published `View` contract mirroring [`HotkeyAltPositionPickerGridAnchorModel`], threaded to this component as data.
#[derive(Clone, PartialEq)]
pub struct HotkeyAltPositionPickerGridAnchorView {
    pub grid_config: GridEditorView,
}

impl ddd::View for HotkeyAltPositionPickerGridAnchorView {}
