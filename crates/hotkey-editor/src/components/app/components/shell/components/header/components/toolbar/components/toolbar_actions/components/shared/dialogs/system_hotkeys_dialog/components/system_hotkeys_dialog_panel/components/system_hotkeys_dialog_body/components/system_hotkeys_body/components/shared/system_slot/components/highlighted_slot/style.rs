...
// keyboard-focus glows are keyed off the host's named `group/tooltip`. The highlighted
// look adds a gold glow overlay (its picker is open, or it is the current drop target).
classes! {
    base: tw![
        "size-full",
        "flex",
