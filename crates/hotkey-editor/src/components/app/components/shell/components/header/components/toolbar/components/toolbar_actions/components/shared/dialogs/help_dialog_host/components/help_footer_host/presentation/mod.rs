...
pub(super) struct HelpFooterHostPresentation {
...
pub(super) fn use_help_footer_host() -> HelpFooterHostPresentation {
    ...
    HelpFooterHostPresentation { on_dismiss }
}

impl ddd::Presentation for HelpFooterHostPresentation {
