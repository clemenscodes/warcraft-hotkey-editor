use super::model::AltPositionPickerModel;
...
impl From<&AltPositionPickerPresentation> for AltPositionPickerShell {
    fn from(model: &AltPositionPickerPresentation) -> Self {
...
pub(super) struct AltPositionPickerPresentation {
...
pub(super) fn use_alt_position_picker(
    props: &AltPositionPickerModel,
) -> AltPositionPickerPresentation {
