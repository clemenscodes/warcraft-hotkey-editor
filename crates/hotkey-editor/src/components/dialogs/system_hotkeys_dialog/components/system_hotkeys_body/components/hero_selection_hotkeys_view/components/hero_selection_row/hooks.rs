...
use crate::components::dialogs::system_hotkeys_dialog::components::system_hotkeys_body::components::shared::slot_button::SlotButtonProps;
use dioxus::prelude::*;
...
/// Builds the binding map, the gold-frame variable, and the three slot buttons.
