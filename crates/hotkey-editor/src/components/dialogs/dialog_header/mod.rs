...
const DECORATION_CLASS: &str = "h-[2.4rem] w-auto flex-none [filter:drop-shadow(0_1px_0_rgba(0,0,0,0.7))] max-[1099px]:w-[44px] max-[480px]:w-[32px]";
const TITLE_CLASS: &str = "m-0 font-friz-quadrata uppercase tracking-[0.08em] text-[2.5rem] leading-none text-warcraft-gold [text-shadow:1px_1px_0_#000,0_0_18px_rgba(255,206,99,0.35)] max-[1099px]:text-[clamp(12px,3.2vw,18px)] max-[1099px]:tracking-[0.02em] max-[1099px]:whitespace-nowrap max-[1099px]:overflow-hidden max-[1099px]:text-ellipsis max-[1099px]:min-w-0 max-[1099px]:max-w-full";
...
pub fn DialogHeader(props: DialogHeaderProps) -> Element {
    ...
    rsx! {
        header {
            class: "relative flex items-center justify-center gap-6 flex-none pt-[1.6rem] px-[4.5rem] pb-[1.4rem] [border-bottom:1px_solid_rgba(255,206,99,0.4)] [box-shadow:0_1px_0_rgba(0,0,0,0.7),0_2px_0_rgba(255,206,99,0.1)] max-[1099px]:gap-2 max-[1099px]:px-[2rem] max-[480px]:px-[1.4rem]",
            img {
