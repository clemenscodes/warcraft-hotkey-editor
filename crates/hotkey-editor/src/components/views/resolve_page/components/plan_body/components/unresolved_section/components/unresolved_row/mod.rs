...
use crate::components::views::resolve_page::components::plan_body::components::fight_row::FightRow;
use crate::components::views::resolve_page::components::plan_body::components::mini_grid::MiniGrid;
use crate::components::views::resolve_page::components::plan_body::components::move_card::MoveCard;
use crate::components::views::resolve_page::components::plan_body::components::move_reason_row::MoveReasonRow;
use crate::components::views::resolve_page::components::plan_body::components::move_transition::MoveTransition;
use dioxus::prelude::*;
