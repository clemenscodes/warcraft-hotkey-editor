...
use crate::components::views::resolve_page::components::plan_body::components::move_name::MoveName;
use crate::components::views::resolve_page::components::plan_body::components::object_id::ObjectId;
use dioxus::prelude::*;
