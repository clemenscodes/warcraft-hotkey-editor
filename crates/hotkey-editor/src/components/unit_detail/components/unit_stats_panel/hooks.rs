use super::components::attributes_column::HeroDisplayData;
use super::components::combat_column::AttackDisplayData;
use super::leveled_stats::LeveledStats;
use super::props::UnitStatsPanelProps;
use super::stat_icon::StatIcon;
use crate::components::unit_detail::derived_stats::DerivedStats;
use dioxus::prelude::*;
