...
//!
//! The value leaves (`StatRowValue`, `StatRowGain`) are generic over a domain figure
//! and render it — the way `Grid` is generic over its tile kind. Per COMPONENTS.md
//! ("Types at the props boundary") the UI owns how it presents a normalized domain
