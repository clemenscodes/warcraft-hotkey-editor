...
declare global {
    interface Window {
        __tooltipTouchInstalled?: boolean;
    }
}
...
let activePress: ActiveLongPress | null = null;
...
function ensureBannerElement(): HTMLElement {
...
function positionBannerNearAnchor(banner: HTMLElement, anchor: HTMLElement): void {
...
function hideTooltip(anchor: HTMLElement): void {
...
function cancelActivePress(): void {
    if (!activePress) {
        return;
    }
